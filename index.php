    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="col-12 col-md-8 text-center">
                ...
                <p class="lead  ">Prihvati izazov i učini najbolje za sebe. Donesi odluku da kreneš i uz podršku trenera i
                    tima postigneš svoj najbolji rezultat.
    ...
    <div class="container pb-5 pt-5">
        <div class="row align-items-center justify-content-between ">
            <div class="col-12 col-md-5 pr-md-5 ">
                ...
                <p class="lead  ">Za 60 dana do trajne promjene. Napravi prvi korak i donesi odluku. Pridruži se ekipi sa
                    iskustvom i preko 400 rezultata. Uz podršku trenera i tima napravi svoj najbolji rezultat. Pogledajte video
                    kako je najbolje početi.</p>
    ...
    <div class="container pb-5 pt-5">
        <div class="row align-items-center justify-content-between ">
            <div class="col-12 col-md-5 pr-md-5 ">
                ...
                <p class="lead  ">Inspirisan rezutatima drugih uz najbolji početak: Izazov doručka napravi svoje prve
                    rezultate i promjenom navika, uživaj u dobrom izgledu i osjećaju. Pogledaj iskustva :</p>
                <div class="  d-flex mt-3 mb-1">
                    <a class="btn btn-success btn-lg  mt-md-3  " href="#" role="button">Learn more now</a>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col text-center">
                    © 2021 © 4FitLIFE.com – Sva prava pridržana. Zabranjeno neovlašteno kopiranje sadržaja.
                </div>
            </div>
        </div>
    </footer>
...
<div class="form-popup" id="myForm">
    ...
    <form action="new.php"  method="post" class="form-container">
        ...
        <input type="text" id="txtName" placeholder="Upišite ime i prezime"  required >

        <label for="txtPhoneNum"><b>Broj telefona</b></label>
        <input type="number" id="txtPhoneNum" placeholder="Upišite broj telefona"  required >

        <label for="txtEmail"><b>Email</b></label>
        <input type="text" id="txtEmail" placeholder="Upišite E-mail" required>
